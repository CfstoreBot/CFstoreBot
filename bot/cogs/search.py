...
def search(update: Update, context: CallbackContext):
    ...
    if check_status(user_id):
        ...
        if len(keyboard_search) == 1:
            ...
            keyboard.append([InlineKeyboardButton(f'🏦 {button_search_bank}', switch_inline_query_current_chat='banco '+banco), InlineKeyboardButton(f'💳 {button_search_scheme}', switch_inline_query_current_chat='bandeira '+bandeira), InlineKeyboardButton(f'🔍 {button_search_bin}', switch_inline_query_current_chat='bin '+bin_num)])
